        ...
        >
          ...
          <Typography
            ...
            sx={{
              textAlign: "center",
              padding: theme.spacing(3),
              textShadow: "2px 4px 8px rgba(0, 0, 0, 0.83)",
        ...
        <Main open={open} sx={{ backgroundColor: "white" }}>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                <CardActionArea
                  href="https://youtu.be/RT5fgigTKSM"
                  target="_blank"
                >
                  ...
                  <CardContent>
                    ...
                    >
                      Oneplus Nord CE 4 is here - A New Competitor ! and A
                      mid-range flagship? oneplus nord ce 4 | oneplus nord ce 4
                      review.This video is all about the oneplus nord CE 4
                      mobile review.
                    </Typography>
                  </CardContent>
                </CardActionArea>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                <CardActionArea
                  href="https://youtu.be/qVG-y2V8zaM"
                  target="_blank"
                >
                  ...
                  <CardContent>
                    <Typography
                      ...
                      sx={{ fontSize: 16, textAlign: "center" }}
                    >
                      In this video im gonna show you some Top 5 lastest and
                      must try features in Android14 Android 15 developer
                      preview.
                    </Typography>
                  </CardContent>
                </CardActionArea>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                <CardActionArea
                  href="https://youtu.be/JOy6NDPIGb0"
                  target="_blank"
                >
                  ...
                  <CardContent>
                    <Typography
                      ...
                      sx={{ fontSize: 16, textAlign: "center" }}
                    >
                      Today we are reviewing the all new OPPO Find X7 Ultra.
                      OPPO Find X7 Ultra packs Quad 50MP camera setup with
                      world's first dual periscope cameras, 120Hz Curved AMOLED
                      Screen, Snapdragon 8 Gen 3 & More
                    </Typography>
                  </CardContent>
                </CardActionArea>
              </Card>
